---
title: Week2- Prepare data - part 1
...
You can download the project from the repository for [forecasting using r](https://github.com/bahmanrostamitabar/forecasting_using_r) and work on it on your own. This includes all weekly analysis.

**Learning outcomes**

In this post, we start at looking at how to prepare data for analysis. 
...
knitr::include_graphics("../../static/img/dp1.PNG")
```
...
```{r tidy_untidy}
knitr::include_graphics("../../static/img/tidy-1.png")
```
