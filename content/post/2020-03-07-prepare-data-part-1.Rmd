...
I cover the most important aspects of data preparation in three seperate posts. In this post, I will discuss how to import data, check if it is in a tidy format and explore it.
...
> **Note:** use`Option -` on MacOS and `Alt -` on Windows and avois typing the assignment operator
...
![Data structure in R \label{fig1}](/img/dp1.png)
...
![Tidy data \label{fig2}](/img/tidy-1.png)
