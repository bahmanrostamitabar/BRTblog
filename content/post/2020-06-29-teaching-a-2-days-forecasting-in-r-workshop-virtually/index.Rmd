...
1. **Blogdown:** I have created a personal website using [Blogdown](https://bookdown.org/yihui/blogdown/) in the past which gave me confidence in creating the website for this workshop. But, I still had to learn what are the different ways to share materials and which one I have to choose. Another great resource from RStudio which helped me to get an overview of potential options and how to do it can be found here: [Sharing on Short Notice: How to Get Your Materials Online With R Markdown](https://rstudio.com/resources/webinars/sharing-on-short-notice-how-to-get-your-materials-online-with-r-markdown/).
