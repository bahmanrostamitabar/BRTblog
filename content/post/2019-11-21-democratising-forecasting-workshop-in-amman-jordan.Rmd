...
- an academic,researcher, professional,  student(UG, MSc., PhD) and want to learn about time series forecasting using R software;
- professional want to learn how to analyse data and produce forecasts to inform decisions using R in the organisations(I encourage people in healthcare to attend);
